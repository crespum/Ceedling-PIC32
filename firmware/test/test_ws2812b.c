...
void test_should_DecodeHex_when_ValidInput(void) {
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 1
    PLIB_PORTS_PinClear_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5);
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 1
    PLIB_PORTS_PinClear_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5);
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 1
    PLIB_PORTS_PinClear_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5);
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 0
    PLIB_PORTS_PinClear_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5);
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 0
    PLIB_PORTS_PinClear_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5);
    PLIB_PORTS_PinSet_Expect(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_5); // 1
